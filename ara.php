...
?>
            ...
            <div id="ortamenu">
               ...
               <center> <h2>ARAMA SONUÇLARI</h2> </center>
                   <?php
			...
			if($arama==""){
				header("Location:anasayfa.php");
					...
					$bul=mysql_query("SELECT * FROM  oyun_ozellik WHERE oyun_adi LIKE '%$arama%' ");
					while($getir=mysql_fetch_array($bul)){
			
					 echo '<div id="oyun">

                        <div id="resim">
                          <a href="oyunekranii.php?id='.$getir['oyun_id'].'">  <img src='.$getir["oyun_resim"].' width="178" height="150" /> </a>
